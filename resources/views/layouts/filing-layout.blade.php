...
<html lang="en">
  ...
  <link rel="icon" href="{{ asset('assets/tailwind-dashboard/build') }}/favicon.ico"><link href="{{ asset('assets/tailwind-dashboard/build') }}/style.css" rel="stylesheet"></head>
...
>
  ...
  <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
    <a href="{{ asset('assets/tailwind-dashboard/build') }}/index.html">
      <img src="{{ asset('assets/tailwind-dashboard/build') }}/src/images/logo/logo.svg" alt="Logo" />
    </a>
  ...
  >
        ...
        <ul class="mb-6 flex flex-col gap-1.5">
          ...
          <li>
            <a
              ...
              href="{{ asset('assets/tailwind-dashboard/build') }}/#"
              ...
              <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                <li>
                  <a
                    ...
                    href="{{ asset('assets/tailwind-dashboard/build') }}/index.html"
          ...
          <li>
            <a
              class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
              href="{{ asset('assets/tailwind-dashboard/build') }}/calendar.html"
          ...
          <li>
            <a
              class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
              href="{{ asset('assets/tailwind-dashboard/build') }}/profile.html"
            ...
            >
              <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                <li>
                  <a
                    class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                    href="{{ asset('assets/tailwind-dashboard/build') }}/form-elements.html"
                ...
                <li>
                  <a
                    class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                    href="{{ asset('assets/tailwind-dashboard/build') }}/form-layout.html"
          ...
          <li>
            <a
              ...
              href="{{ asset('assets/tailwind-dashboard/build') }}/tables.html"
          ...
          <li>
            <a
              class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
              href="{{ asset('assets/tailwind-dashboard/build') }}/settings.html"
      ...
      <div>
        ...
        <ul class="mb-6 flex flex-col gap-1.5">
          ...
          <li>
            <a
              class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
              href="{{ asset('assets/tailwind-dashboard/build') }}/chart.html"
            ...
            >
              <ul class="mb-3 mt-4 flex flex-col gap-2 pl-6">
                <li>
                  <a
                    class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                    href="{{ asset('assets/tailwind-dashboard/build') }}/alerts.html"
                ...
                <li>
                  <a
                    class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                    href="{{ asset('assets/tailwind-dashboard/build') }}/buttons.html"
            ...
            >
              <ul class="mb-3 mt-4 flex flex-col gap-2 pl-6">
                <li>
                  <a
                    class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                    href="{{ asset('assets/tailwind-dashboard/build') }}/signin.html"
                ...
                <li>
                  <a
                    class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                    href="{{ asset('assets/tailwind-dashboard/build') }}/signup.html"
    ...
    >
      ...
      <a
        href="{{ asset('assets/tailwind-dashboard/build') }}/https://tailadmin.com/pricing"
        target="_blank"
        rel="nofollow"
...
>
  ...
  >
    <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
      ...
      <!-- Hamburger Toggle BTN -->
      <a class="block flex-shrink-0 lg:hidden" href="{{ asset('assets/tailwind-dashboard/build') }}/index.html">
        <img src="{{ asset('assets/tailwind-dashboard/build') }}/src/images/logo/logo-icon.svg" alt="Logo" />
      </a>
    </div>
            ...
            <ul class="flex h-auto flex-col overflow-y-auto">
              <li>
                <a
                  ...
                  href="{{ asset('assets/tailwind-dashboard/build') }}/messages.html"
                >
                  <div class="h-12.5 w-12.5 rounded-full">
                    <img src="{{ asset('assets/tailwind-dashboard/build') }}/src/images/user/user-02.png" alt="User" />
                  </div>
              ...
              <li>
                ...
                >
                  <div class="h-12.5 w-12.5 rounded-full">
                    <img src="{{ asset('assets/tailwind-dashboard/build') }}/src/images/user/user-01.png" alt="User" />
                  </div>
              ...
              <li>
                ...
                >
                  <div class="h-12.5 w-12.5 rounded-full">
                    <img src="{{ asset('assets/tailwind-dashboard/build') }}/src/images/user/user-03.png" alt="User" />
                  </div>
              ...
              <li>
                ...
                >
                  <div class="h-12.5 w-12.5 rounded-full">
                    <img src="{{ asset('assets/tailwind-dashboard/build') }}/src/images/user/user-04.png" alt="User" />
                  </div>
...
>
  ...
  <div class="flex flex-col">
    ...
    >
      <div class="flex items-center gap-3 p-2.5 xl:p-5">
        <div class="flex-shrink-0">
          <img src="{{ asset('assets/tailwind-dashboard/build') }}/src/images/brand/brand-01.svg" alt="Brand" />
        </div>
    ...
    >
      <div class="flex items-center gap-3 p-2.5 xl:p-5">
        <div class="flex-shrink-0">
          <img src="{{ asset('assets/tailwind-dashboard/build') }}/src/images/brand/brand-02.svg" alt="Brand" />
        </div>
        <p class="hidden font-medium text-black dark:text-white sm:block">
          Twitter
        </p>
    ...
    >
      <div class="flex items-center gap-3 p-2.5 xl:p-5">
        <div class="flex-shrink-0">
          <img src="{{ asset('assets/tailwind-dashboard/build') }}/src/images/brand/brand-03.svg" alt="Brand" />
        </div>
        <p class="hidden font-medium text-black dark:text-white sm:block">
          Github
        </p>
    ...
    >
      <div class="flex items-center gap-3 p-2.5 xl:p-5">
        <div class="flex-shrink-0">
          <img src="{{ asset('assets/tailwind-dashboard/build') }}/src/images/brand/brand-04.svg" alt="Brand" />
        </div>
        <p class="hidden font-medium text-black dark:text-white sm:block">
          Vimeo
        </p>
    ...
    <div class="grid grid-cols-3 sm:grid-cols-5">
      <div class="flex items-center gap-3 p-2.5 xl:p-5">
        <div class="flex-shrink-0">
          <img src="{{ asset('assets/tailwind-dashboard/build') }}/src/images/brand/brand-05.svg" alt="Brand" />
        </div>
        <p class="hidden font-medium text-black dark:text-white sm:block">
          Facebook
        </p>
        ...
        <p class="font-medium text-meta-5">1.9%</p>
              ...
              >
                ...
                <div>
                  ...
                  >
                    <div class="relative h-14 w-14 rounded-full">
                      <img src="{{ asset('assets/tailwind-dashboard/build') }}/src/images/user/user-05.png" alt="User" />
                      <span
    ...
    <!-- ===== Page Wrapper End ===== -->
  <script defer src="{{ asset('assets/tailwind-dashboard/build') }}/bundle.js"></script></body>
</html>
