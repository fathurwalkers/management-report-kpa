                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-3 col-lg-3">
                                                <div class="form-group" id="login_nama">
                                                    ...
                                                    <input name="login_nama" type="text" class="form-control" id="login_nama" aria-describedby="login_nama"required autofocus>
                                                </div>
                                            </div>
                                            <div class="col-sm-12 col-md-3 col-lg-3">
                                                <div class="form-group" id="login_username">
                                                    <label for="login_username" class="form-label">Username</label>
                                                    <input name="login_username" type="text" class="form-control" id="login_username" aria-describedby="login_username" maxlength="5" oninput="this.value = this.value.toUpperCase()" required>
                                            ...
                                            <div class="col-sm-12 col-md-3 col-lg-3">
                                                <div class="form-group" id="login_jabatan">
                                                    ...
                                                    <input name="login_jabatan" type="text" class="form-control" id="login_jabatan" aria-describedby="login_jabatan">
                                                ...
                                                <div class="form-group" id="login_level">
                                                    ...
                                                    <select name="divisi_id" id="login_level" class="form-control">
                                                        ...
                                                        @foreach ($divisi as $divs)
                                                            <option value="{{$divs->id}}">{{$divs->divisi_nama}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-4 col-lg-4">
                                                <div class="form-group" id="login_email">
                                                    ...
                                                    <input name="login_email" type="email" class="form-control" id="login_email" aria-describedby="login_email">
                                                </div>
                                            </div>
                                            <div class="col-sm-12 col-md-4 col-lg-4">
                                                <div class="form-group" id="login_email">
                                                    <label for="login_no_telepon" class="form-label">HP / No. Telepon</label>
                                                    <input name="login_no_telepon" type="number" class="form-control" id="login_no_telepon" aria-describedby="login_no_telepon" maxlength="14">
                                                </div>
                                            </div>
                                        </div>
