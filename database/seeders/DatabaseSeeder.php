...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $employees = [
            ...
            ["Nama" => "Michael Dono T.H", "Div" => "Boiler", "Nik/ID" => "KPA00022", "Jabatan" => 13],
            ...
            ["Nama" => "Jarot Priyono", "Div" => "HSE", "Nik/ID" => "KPA00126", "Jabatan" => 17],
            ...
            ["Nama" => "Yuli Supamrih", "Div" => "Kepala Housekeeping", "Nik/ID" => "KPA00025", "Jabatan" => 18],
            ["Nama" => "Buntoro", "Div" => "Kepala Security", "Nik/ID" => "KPA00034", "Jabatan" => 20],
        ];

        foreach ($employees as $insert) {
            $cari_divisi = $divisi_get->where('id', $insert["Jabatan"])->first();
            $div = $insert['Div'];
            if (in_array($div, ["Human Capital & GA", "PJ Gudang & Admin", "Manager Pabrik"])) {
                $role = 'pj';
            } else {
                $role = 'sp';
            }
